...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2019 at 06:56 AM
...
('root', '[{\"db\":\"hrms\",\"table\":\"per_details\"},{\"db\":\"HRMS\",\"table\":\"per_details\"},{\"db\":\"hrms\",\"table\":\"attendance\"},{\"db\":\"hrms\",\"table\":\"employee_details\"}]');
...
('root', '2019-05-28 04:56:02', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `testtbale`
--
CREATE DATABASE IF NOT EXISTS `testtbale` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `testtbale`;
COMMIT;
